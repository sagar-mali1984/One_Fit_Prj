...
@Component({
    selector: 'crm-enquiry',
    templateUrl: './CRMEnquiry.component.html'
})

export class CRMEnquiryComponent {

    ContactRef: string;
    ContactID: number;
    RecordID: number;
    listContacts: Contact[] = [];
    selectedContact: any = "Select";
    ...
    onTabChange(value: string, tabName: string) {
        //  debugger;
